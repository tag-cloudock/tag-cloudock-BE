...
import tagCloudock.domain.user.domain.Position;
...
import tagCloudock.domain.user.exception.IncorrectPasswordException;
import tagCloudock.domain.user.exception.UserNotFountException;
import tagCloudock.domain.user.repository.UserRepository;
import tagCloudock.global.config.exception.UnauthorizedAccessException;
