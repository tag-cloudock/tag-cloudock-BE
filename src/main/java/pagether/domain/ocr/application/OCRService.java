package pagether.domain.ocr.application;
...
import pagether.domain.ocr.exception.ErrorDetectedException;
import pagether.domain.ocr.exception.ImageNotProvidedException;
